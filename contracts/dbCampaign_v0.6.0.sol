...
contract dreambridgeCampaign_ver {
    ...
    function payPlatform() internal{
      ...
      fee = (CampaignDetails.amountRaised.mul(feePrecent)).div(100); // calculates the platform fee. 5% is standard, 8% for any campaigns the platform launched, 2% additional fee on top of base for derelict campaign redemptions.
